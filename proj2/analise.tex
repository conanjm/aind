...
\subsubsection*{Important to exce in system:開\subsubsection*{\texttt{\$ cat results.txt |sed -e 's/]/],$\backslash$$\backslash$/g' >load\_results.py}開\subsubsection*{And edit the file \texttt{load\_results.py} adding: '\texttt{results = [}' at begin, and change the last '\texttt{,$\backslash$'} by '\texttt{]}'.開\subsubsection*{Machine: Intel(R) Xeon(R) CPU E3-1241 v3 @ 3.50GHz開
...
\subsubsection*{1) Use a table or chart to analyze the number of nodes expanded against number of actions in the domain開\subsubsection*{2) Use a table or chart to analyze the search time against the number of actions in the domain開
...
\subsubsection*{3) Use a table or chart to analyze the length of the plans returned by each algorithm on all search problems開
